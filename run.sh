...
#
# 기본값은 이 머신의 포트포워딩(NAT)에 맞춰져 있다: 내부 8080/5173 포트가
# 공인 IP 쪽 34762/35915 로 매핑되어 있다(service.gsmsv.site). PUBLIC_PORT는
...
#
#   ./run.sh                    # API 내부 8080(공인 34762), 화면 5173(공인 35915), GPU 0,1
